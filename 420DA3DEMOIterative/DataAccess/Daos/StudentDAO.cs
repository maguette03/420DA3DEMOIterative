...
namespace _420DA3DEMOIterative.DataAccess.Daos
{
    public class StudentDAO
    {
        ...
        {
            SqlConnection conn = transaction?.Connection ?? connection;
            SqlCommand getAllCommand = connection.CreateCommand();
        ...
        public Student Create(Student etudiant, SqlTransaction? transaction = null)
        {
            ...
            insertCommand.CommandText = $"INSERT INTO {tableName} (`FirstName`, `LastName`, `Code`, `RegistrationDate`) "
            ...
            return GetById(creationId, transaction);
        }
        ...
        public Student Update(Student etudiant, SqlTransaction? transaction = null)
        {
            ...
            return GetById(etudiant.Id, transaction);
        }
