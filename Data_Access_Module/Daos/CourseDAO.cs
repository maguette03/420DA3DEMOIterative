...
namespace Data_Access_Module.Daos
{
    internal class CourseDAO
    {
        ...
        public Course Create(Course cours)
        {
            ...
            insertCommand.CommandText = string.Format(sqlQuery, this.tableName, cours.NomCours, cours.CodeCours, cours.NbrHeure);
            ...
            return this.GetById(creationId);
        }
        ...
        public Course Update(Course cours)
        {
            ...
            updateCommand.CommandText = String.Format(sqlQuery, this.tableName, cours.NomCours,
        ...
        public Course Delete(Course cours)
        {
            ...
            deleteCommand.CommandText = String.Format(sqlQuery, this.tableName, cours.Id);
            if (this.connection.State != System.Data.ConnectionState.Open)
            {
                this.connection.Open();
            }
